...
public class Util {
    ...
    static File fileI = new File("TwitterMapperStarter/data/defaultProfileImage.png");
    public static BufferedImage defaultImage;

    static {
        try {
            defaultImage = ImageIO.read(fileI);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    // public static BufferedImage defaultImage = imageFromURL("https://homepages.cae.wisc.edu/~ece533/images/airplane.png");
